...
const String topico = "Lucas w"; //nome do tópico
...
void loop() {
    //String msg = "lucas w: Oi";  //Informação que será enviada para o broker
    ...
    if(Serial.available() > 0){
        ...
        // mensagem = "lucas w: " + mensagem;
        mqtt.publish("Raul",mensagem.c_str()); //envia msg
    } 
