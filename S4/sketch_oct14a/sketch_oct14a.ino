...
const String topico = "Raul"; //nome do tópico
...
void loop() {
    //String msg = "Raul: Oi";  //Informação que será enviada para o broker
    ...
    if(Serial.available() > 0){
        ...
        // mensagem = "Raul: " + mensagem;
        mqtt.publish("Lucas w",mensagem.c_str()); //envia msg
    } 
